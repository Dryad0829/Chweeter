...
import "./Sidebar.css";
import TransitionsModal from "../utils/TransitionsModal.js";
  ...
  return (
    <div className="sidebar">
      <div className="sidebarOptionss">
        ...
        <Link to='/home' className="line_color"><SidebarOption active Icon={HomeIcon} text="Home" /></Link>
        ...
        <Link to='/bookmarks' className="line_color"><SidebarOption Icon={BookmarkBorderIcon} text="Bookmarks" /></Link>
